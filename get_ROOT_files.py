...
parser.add_argument("-d", "--dir", type=str, default='/eos/cms/store/group/phys_exotica/monoZ/MonoZAnalysis_BladeRunner_MonoZ_2017_1111/', help="top directory containing all the datasets")
