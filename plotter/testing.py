...
Var_Dict = [
        ...
        {'variable':'met_pt',                  'nBins':15,             'xLow':0,               'xHi':3000,	'title':'p_{T}^{miss} [GeV]'}
	]
...
#_cuts = "((lep_category==6 || lep_category==7) && Z_mass > 76 && Z_mass < 106 && Z_pt>60 && ngood_jets < 2 && ngood_bjets == 0)"# && met_pt > 40 && Flag_METFilters == 1 && Flag_CSCTightHaloFilter == 1)"# && abs(delta_met_rec) < 1)"
...
_cuts = "((lep_category==4 || lep_category==5) && Z_pt>60 && Z_mass > 76 && Z_mass < 106 && met_pt > 30 && emulatedMET > 100 && mass_alllep > 100 && ngood_jets < 2 && ngood_bjets == 0 && emulatedMET/Z_pt > 0.6 && emulatedMET/Z_pt < 1.4 && abs(emulatedMET_phi-Z_phi) > 2.5 && delta_R_ll < 1.8)"# && delta_R_ll < 1.8)"#&& ngood_jets < 3 && abs(delta_phi_ZMet) > 2.5 && emulatedMET > 100)"#
...
def test(_variable,_nBins,_xLow,_xHi,title):
   ...
   lab2.SetTextFont(42)
   cmsTag = 'e#mu ch., 59.9 fb^{-1} (13 TeV)'
