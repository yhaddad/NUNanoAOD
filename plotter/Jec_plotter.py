...
with open('ROOTfiles_2018_MC_NewJecs.yml', 'r') as f2_yml:
...
Dict = [
        ...
        {'dataset':'GluGluToContinToZZTo2e2nu_13TeV_MCFM701_pythia8',            'name':'Other',              'Scale':1.0000366999035346/1000.0,          'FillColor':880+1 ,             'LineColor':880+1 },
        {'dataset':'GluGluToContinToZZTo2e2tau_13TeV_MCFM701_pythia8',            'name':'Other',              'Scale':1.0000352648819979/1000.0,          'FillColor':880+1 ,             'LineColor':880+1 },
        {'dataset':'GluGluToContinToZZTo2mu2nu_13TeV_MCFM701_pythia8',            'name':'Other',              'Scale':1.000036237395034/1000.0,          'FillColor':880+1 ,             'LineColor':880+1 },
        ...
        {'dataset':'GluGluToContinToZZTo4tau_13TeV_MCFM701_pythia8',            'name':'Other',              'Scale':1.0000347018778029/1000.0,          'FillColor':880+1 ,             'LineColor':880+1 },
        {'dataset':'ZZTo2L2Nu_TuneCP5_13TeV_powheg_pythia8',            'name':'ZZ',                 'Scale':1.6644254116087271/1000.0,          'FillColor':800-2 ,             'LineColor':800-2 },
        {'dataset':'ZZTo4L_TuneCP5_13TeV_powheg_pythia8',            'name':'ZZ',                 'Scale':0.75483123178862355/1000.0,          'FillColor':800-2 ,             'LineColor':800-2 },
        #ZZTo2L2Q{'dataset':'',            'name':'ZZ',                 'Scale':,          'FillColor':800-2 ,             'LineColor':800-2 },
	{'dataset':'WZTo3LNu_TuneCP5_13TeV-powheg-pythia8',            'name':'WZ',                 'Scale':0.21472297323437994/1000.0,          'FillColor':860-4 ,             'LineColor':860-4 },
	...
	{'dataset':'TTWJetsToLNu_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8',            'name':'TT',                 'Scale':2.9063161256383729,          'FillColor':920+1 ,             'LineColor':920+1 },
        ...
        #TTZ{'dataset':'',            'name':'TT',                 'Scale':,          'FillColor':920+1 ,             'LineColor':920+1 },
        {'dataset':'ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8',            'name':'TT',                 'Scale':0.02866146461187432,          'FillColor':920+1,             'LineColor':920+1 },
	...
	{'dataset':'WWZ_TuneCP5_13TeV-amcatnlo-pythia8',            'name':'VVV',                'Scale':5.9833339303752018,          'FillColor':900-5 ,             'LineColor':900-5 },
        ...
        {'dataset':'DY2JetsToLL_M-50_LHEZpT_150-250_TuneCP5_13TeV-amcnloFXFX-pythia8',            'name':'DY',                 'Scale':0.014435638439296296/1.23,          'FillColor': 900+1,             'LineColor':900+1 },
...
Var_Dict = [
        ...
        {'variable':'lead_jet_pt',           'nBins':1000,             'xLow':0,            'xHi':1000,      'title':'p_{T}^{jet} [GeV]'},
        ...
        #{'variable':'Z_pt',         		'nBins':15,             'xLow':0,		'xHi':300,	'title':'p_{T}^{ll} [GeV]'},
        ...
        {'variable':'met_pt',                  'nBins':15,             'xLow':0,               'xHi':300,	'title':'p_{T}^{miss} [GeV]'}
	]
...
_cuts = "((lep_category==1 || lep_category==3) && Z_mass > 76 && Z_mass < 106 && Z_pt>60)"# && ngood_jets < 2 && ngood_bjets == 0)"# && met_pt > 40)"# && abs(delta_met_rec) < 1)"
...
def test(_variable,_nBins,_xLow,_xHi,title):
   ...
   #leg.AddEntry(mc, "2017 JECs", "F")
   #leg.AddEntry(dat, "2018 JECs", "F")

   dathists = [None] * _ndatasets
   ...
   cOutput.SaveAs("plots/" + _variable + "_2018Jecs.pdf") 
   dat.Delete()
   dat2.Delete()
   stk.Delete()
   mc.Delete()
