...
#_cuts = "((lep_category==1))"# && Z_mass > 76 && Z_mass < 106 && Z_pt>60 && ngood_jets < 2 && ngood_bjets == 0 && abs(delta_phi_ZMet) > 2.8 && met_pt>100 && delta_R_ll < 1.8 && abs(delta_phi_j_met) > 0.5 && sca_balance < 1.4 && sca_balance > 0.6  && nhad_taus==0)"
_cuts = "1"
