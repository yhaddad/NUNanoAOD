...
python condor_Run2_proc.py --jobNum=$1 --isMC=1 --era=2016 --infile=$2
echo "----- transfert output to eos :"
xrdcp -s -f tree_$1.root root://eoscms.cern.ch//store/group/phys_exotica/monoZ/ADD_Truncation_v2_2016/ADDMonoZ_ZtoLL_MD-2_d-5_TuneCUETP8M1_13TeV-pythia8/
