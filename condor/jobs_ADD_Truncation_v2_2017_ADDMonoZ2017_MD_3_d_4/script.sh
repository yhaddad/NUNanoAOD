...
python condor_Run2_proc.py --jobNum=$1 --isMC=1 --era=2017 --infile=$2
echo "----- transfert output to eos :"
xrdcp -s -f tree_$1.root root://eoscms.cern.ch//store/group/phys_exotica/monoZ/ADD_Truncation_v2_2017/ADDMonoZ2017_MD_3_d_4/
